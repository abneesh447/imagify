...
const Header = () => {
  ...
  return (
    ...
    viewport={{once: true}}
    >
        <motion.div className='text-stone-500 inline-flex text-center gap-2 bg-white px-6 
        ...
        >Unlease your creativity with AI. Turn your imagination 
            into visual art in seconds - just type, and watch the magic happen.</motion.p>
        ...
        className='flex gap-3 mt-16 flex-wrap justify-center '>
            {Array(6).fill('').map((item,idx)=>(
                ...
                cursor-pointer max-sm:w-10' src={idx%2==0? assets.sample_img_1 : assets.sample_img_2} 
                key={idx} width={70}/>
            ))}
        </motion.div>
        <motion.p
